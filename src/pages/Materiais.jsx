        ...
        <section>
            <div className='mb-44 '>
                <div className='flex items-center'>
                    <h2 className='text-purple font-titulo sm:text-3xl sm:px-44 sm:pr-12 text-1xl pr-10 pl-10'>Utilização</h2>
                ...
                <div className=' mt-24 transform transition ease-in-out duration-1000 float-effect'>
                    ...
                    <img src={imgRoboMateriais} alt="Robô da página de materiais" className="sm:w-[428px] sm:h-[512px]  mx-auto"/>
                </div>
