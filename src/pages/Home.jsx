    ...
    return (
     <main className=" flex items-center justify-center min-h-screen ">
        ...
        <div className=" flex items-center " >
            ...
            <div>
                <h1 className= "text-4xl font-semibold text-violet-500 mb-4">Robô Kids</h1>
                <p className="text-lg mb-8 text-justify">Trata-se de um produto  destinado a ajudar crianças em sua jornada de aprendizado, com ênfase na disciplina de matemática. Por meio da integração da tecnologia, as crianças podem se divertir enquanto aprendem, ao passo que os pais têm a oportunidade de monitorar o progresso de seus filhos.</p>
                <button className="px-6 py-3 bg-violet-400 text-white rounded-lg transition ease-in-out delay-150 bg-violet-600 hover:-translate-y-1 hover:scale-110 hover:bg-indigo-500 duration-100 ...mb-8">
