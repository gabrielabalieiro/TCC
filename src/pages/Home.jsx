    ...
    return (
     <main className=" flex items-center justify-center min-h-screen ">
        ...
        <div className=" flex items-center " >
            ...
            <div>
                <h1 className= "text-6xl font-semibold text-purple mb-4 text-[64px] font-normal font-titulo">Robô Kids</h1>
                <p className="w-[565px] text-justify text-black text-2xl  py-8 font-normal font-paragrafo">Trata-se de um produto  destinado a ajudar crianças em sua jornada de aprendizado, com ênfase na disciplina de matemática. Por meio da integração da tecnologia, as crianças podem se divertir enquanto aprendem, ao passo que os pais têm a oportunidade de monitorar o progresso de seus filhos.</p>
