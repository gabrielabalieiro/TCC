  ...
  return (
    <main className="min-h-screen flex justify-center items-center">
        ...
        <section className="py-20">
            <div>
                <h2 className='text-purple text-3xl font-titulo my-14 font-normal '>Funcionamento</h2>
                <hr className='border-violet '/>
                <p className='font-topico text-purple text-2xl  mb-5'>Guia de utilização</p>
                <div>
