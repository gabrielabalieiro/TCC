  ...
  return (
    <main>
        <section>
            ...
            <div>
                <h2 className='subtópicos'>Fontes - Artigos científicos</h2>
            </div>
        </section>
    </main>
  )
